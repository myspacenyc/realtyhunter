    ...
    # listings and incur large fees.
      ...
      listings = listings.where("residential_listings.streeteasy_flag = TRUE or residential_listings.streeteasy_flag_one = TRUE or
		...
		listings = listings
			...
			'units.listing_id', 'units.updated_at', 'units.rent', 'units.gross_price', 'units.promotional_price', 'units.streeteasy_unit' ,
			...
			'residential_listings.streeteasy_flag', 'residential_listings.streeteasy_flag_one', 'residential_listings.streeteasy_url',
